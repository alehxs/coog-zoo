...
const GiftManager = () => {
  ...
  const fetchItems = async () => {
    try {
      ...
      const response = await fetch('https://coog-zoo.onrender.com/giftshop-items-all', {
        method: 'GET',
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const endpoint = editingItem 
        ? `https://coog-zoo.onrender.com/giftshop-items/${editingItem.Item_ID}` 
        : 'https://coog-zoo.onrender.com/giftshop-items';
  ...
  const handleToggleActive = async (itemId, currentStatus) => {
    try {
      const response = await fetch(`https://coog-zoo.onrender.com/giftshop-items/${itemId}/toggle-active`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },

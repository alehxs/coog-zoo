...
const GiftShopPage = (showSidebar) => {
  ...
  const fetchGiftShopItems = async () => {
    try {
      const response = await fetch('https://coog-zoo.onrender.com/giftshop-items');
      if (!response.ok) {
  ...
  const fetchPurchaseHistory = async () => {
    try {
      const response = await fetch(`https://coog-zoo.onrender.com/giftshop-history?email=${encodeURIComponent(userEmail)}`);
      if (!response.ok) {
  ...
  const handlePurchase = async (e) => {
    ...
    try {
      setError(null);
      const response = await fetch('https://coog-zoo.onrender.com/purchase-giftshop-item', {
        method: 'POST',
        headers: {

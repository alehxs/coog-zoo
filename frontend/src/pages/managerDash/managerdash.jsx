...
function ManagerDash() {
  ...
  const addEmployee = async () => {
    try {
      const response = await fetch('https://coog-zoo.onrender.com/add-employee', {
        method: 'POST',
  ...
  const deleteEmployee = async () => {
    try {
      const response = await fetch(`https://coog-zoo.onrender.com/remove-employee?id=${employeeId}&managerEmail=${managerEmail}`, {
        method: 'DELETE',
      });
  ...
  const addExhibit = async () => {
    try {
      const response = await fetch('https://coog-zoo.onrender.com/add-exhibit', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const deleteExhibit = async () => {
    try {
      const response = await fetch(`https://coog-zoo.onrender.com/remove-exhibit?id=${exhibitId}`, {
        method: 'DELETE',
      });
  ...
  const addAnimal = async () => {
    try {
      const response = await fetch('https://coog-zoo.onrender.com/add-animal', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const deleteAnimal = async () => {
    try {
      const response = await fetch(`https://coog-zoo.onrender.com/remove-animal?id=${animalId}`, {
        method: 'DELETE',
      });
  ...
  const addCage = async () => {
    try {
      const response = await fetch('https://coog-zoo.onrender.com/add-cage', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const deleteCage = async () => {
    try {
      const response = await fetch(`https://coog-zoo.onrender.com/remove-cage?id=${cageId}`, {
        method: 'DELETE',
      });
      if (response.ok) {
  ...
  const addShowcase = async () => {
    try {
      const response = await fetch('https://coog-zoo.onrender.com/add-showcase', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const deleteShowcase = async () => {
    try {
      const response = await fetch(`https://coog-zoo.onrender.com/remove-showcase?id=${showcaseId}`, {
        method: 'DELETE',
      });
      if (response.ok) {
  ...
  const addEvent = async () => {
    try {
      const response = await fetch('https://coog-zoo.onrender.com/add-event', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },

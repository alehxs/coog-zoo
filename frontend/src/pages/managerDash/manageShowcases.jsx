  ...
  function ManageShowcases({ showcaseData, setShowcaseData, addShowcase, showcaseId, setShowcaseId, showSidebar }) {
    ...
    useEffect(() => {
      const fetchShowcase = async () => {
        try {
          const response = await fetch('https://coog-zoo.onrender.com/showcases');
          if (!response.ok) {
    ...
    const updateShowcase = async () => {
      ...
      try {
        const response = await fetch(`https://coog-zoo.onrender.com/update-showcase?id=${updateData.id}`, {
          method: 'PUT',

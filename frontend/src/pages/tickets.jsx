...
const TicketsPage = () => {
  ...
  const fetchExhibits = async () => {
    try {
      ...
      const response = await fetch('https://coog-zoo.onrender.com/exhibits');
      if (!response.ok) {
  ...
  const fetchPurchasedTickets = async () => {
    try {
      ...
      const response = await fetch(`https://coog-zoo.onrender.com/purchased-tickets?email=${encodeURIComponent(userEmail)}`);
      if (!response.ok) {
  ...
  const handlePurchase = async (e) => {
    ...
    try {
      const response = await fetch('https://coog-zoo.onrender.com/tickets', {
        method: 'POST',
        headers: {

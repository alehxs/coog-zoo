...
function Employeedash() {
  ...
  useEffect(() => {
    const fetchEmployeeId = async () => {
      try {
        const response = await fetch(`https://coog-zoo.onrender.com/employee-id?email=${userEmail}`);
    ...
    const fetchAnimals = async () => {
      try {
        const response = await fetch(`https://coog-zoo.onrender.com/employee-animals?email=${userEmail}`);
        const data = await response.json();
        setAnimals(data);
      } catch (error) {
  ...
  const handleReportSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://coog-zoo.onrender.com/add-report', {
        method: 'POST',
        headers: {
  ...
  const handleHealthReportFetch = async (e) => {
    ...
    try {
      const response = await fetch(`https://coog-zoo.onrender.com/health-reports?animalId=${reportQuery.animalId}&startDate=${reportQuery.startDate}&endDate=${reportQuery.endDate}`);
      const data = await response.json();
  ...
  const handlePasswordChange = async (e) => {
    ...
    try {
      const response = await fetch('https://coog-zoo.onrender.com/change-password', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
